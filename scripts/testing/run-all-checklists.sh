...
echo "[PRECHECK] 路由映射静态校验"
python scripts/testing/validate_checklists.py >/dev/null
...
echo "[POSTCHECK] 自动 smoke 探测（离线环境会出现 WARN）"
python scripts/testing/run_smoke_from_checklists.py >/dev/null
